...
-- odpowiedz: kiedy chcemy zignorować pierwszy argument, np mapowania po kolekcjach kiedy chcemy wykorzystać tylko ich długość

-- W jakich sytuacjach może być przydatny operator (<*)?
-- odpowiedz: kiedy chcemy zignorować drugi argument
